...
if (Halcyon.isDev) {
    ...
    associateModule("SaintBypass,+", [!1, !1], "Misc", 0, {
        old: 0,
        state: true,
        toggle() {
            var mod = getModule("SaintBypass");
            if (getState(mod)) {
                /*try{
                ...
                Entity.setRot(Player.getEntity(), 666, 42);
                let Intent = android.content.Intent;
                let intentURL = new Intent(ctx);
                intentURL.setAction(android.content.Intent.ACTION_VIEW);
                intentURL.setData(android.net.Uri.parse("https://www.bing.com/search?q=%D0%94%D0%B5%D0%BB%D0%B0%D1%82%D1%8C+%D0%B2+%D0%BB%D1%8E%D0%B1%D0%BE%D0%BC+%D1%81%D0%BB%D1%83%D1%87%D0%B0%D0%B5+%D0%BD%D0%B5%D1%87%D0%B5%D0%B3%D0%BE%29+%D0%9F%D0%BE%D0%B4%D0%BE%D0%B6%D0%B4%D0%B8+10+%D1%81%D0%B5%D0%BA%D1%83%D0%BD%D0%B4+%D0%B8+%D0%B2%D0%B5%D1%80%D0%BD%D0%B8%D1%81%D1%8C&form=QBLH&sp=-1&pq=%D0%B4%D0%B5%D0%BB%D0%B0%D1%82%D1%8C+%D0%B2+&sc=0-9&qs=n&sk=&cvid=27398B0B47164B71AFA953F8826186CD"));
                ctx.startActivity(intentURL);
                print("Wait 10 seconds and press return button!");
                new java.lang.Thread(new java.lang.Runnable({
                    run() {
                        java.lang.Thread.sleep(10000);
                        //print("You can return to your game!");
                    }
                })).start();
            } else {
...
new function () {
    //icon font
   // java.lang.System.load(android.os.Environment.getExternalStorageDirectory().getAbsolutePath() + "/Halcyon/libnet.nofairplay.crashfix.so");
    //print("loaded??")
...
var clearName = (name) => {
    if(name != -1 && name != null && name != "" && name != undefined)
      return name.replace(/§1/g, "").replace(/§2/g, "").replace(/§3/g, "").replace(/§4/g, "").replace(/§5/g, "").replace(/§6/g, "").replace(/§7/g, "").replace(/§8/g, "").replace(/§9/g, "").replace(/§0/g, "").replace(/§a/g, "").replace(/§b/g, "").replace(/§c/g, "").replace(/§d/g, "").replace(/§e/g, "").replace(/§f/g, "").replace(/§l/g, "").replace(/§k/g, "").replace(/§o/g, "").replace(/§r/g, "")
else
      return "0"
}